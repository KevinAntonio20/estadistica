...
# 2. Determinar que vayan los números con 1D número
...
# los alumnos de 5to y sexto grado de la escuela 
# primaria "Lázaro Cárdenas del Río" de Banderilla. En
# total se tienen 120 alumnos.
...
# 4. ¿Cuántas permutaciones tendremos en total?
