...
# Suponga que hay doce preguntas de opción múltiple en un exámen
# de matemáticas. Cada pregunta tiene cinco posibles respuestas,
# y solo una de ellas es correcta. Encuentre la probabilidad de
# tener cuatro o menos respuestas correctas si un estudiante
...
# matemáticas. Cada pregunta tiene cinco posibles respuestas, y sólo 
# una de ellas es correcta. Encuentre la probabilidad de tener cuatro
...
# Para encontrar la probabilidad de tener cuatro o menos respuestas correctas de forma aleatoria se utiliza la función dbinom con k=0,1,2,3,4.
...
# *NOTA 1:* Se pone la leyenda en el centro del gráfico, buscando la manera en la que no se pierda ningún dato. 

# *NOTA 2:* Se ponen ambos códigos de manera conjunta para que la leyenda salga junto con el gráfico. 
...
#binomial. 
# *NOTA:* La leyenda se cambia de lugar para que no se tape ningún 
#dato
...
#  Rejilla de valores del eje X, *x=0:50. Se van a utilizar el mismo de valor de "x", y lambda es la que va a ir cambiando, en esta ocasión se ocuparán valores de **5, 10 y 20*. Además de poner la leyenda. 
...
# estudiantes de una Escuela Primaria en un lapso de 15 minutos a 
# la entrada de la escuela. Se puede suponer que la probabilidad 
# de llegada de los estudiantes es la misma que cualquiera de los 
# dos lapsos con la misma dirección siendo estas independientes a 
# que llegue o no el estudiante. El número promedio de alumnos que 
# llegan en un lapso de 15 minutos son 35. Para optimizar la llegada 
# de los estudiantes evitando las aglomeraciones se requiere saber 
# la probabilidad de que lleguen 50 alumnos en 15 minutos.
...
# 1.- ¿Cuál es la probabilidad de que a la escuela lleguen 34 
...
# a) Probabilidad de que 60 alumnos salgan en 5 minutos a la salida
# de la escuela.
...
# observar bien el gráfico, pero el valor de "x" sigue igual, además 
# de que la leyenda también cambia. 
